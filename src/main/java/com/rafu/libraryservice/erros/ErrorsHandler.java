...
public class ErrorsHandler {
  ...
  public ResponseEntity<DefaultError> handleBookAlreadyCreate(
      final BookAlreadyCreate ex, final WebRequest request) {
    log.error(
        InternalErrorsEnum.INTERNAL_ERROR.getFormattedMessage(ex.getClass().getName()),
        ex.getCause());
    final var error =
  ...
  public ResponseEntity<DefaultError> handleEmailInUseException(
      final EmailInUseException ex, final WebRequest request) {
    log.error(
        InternalErrorsEnum.INTERNAL_ERROR.getFormattedMessage(ex.getClass().getName()),
        ex.getCause());
    final var error =
  ...
  public ResponseEntity<DefaultError> handleWrongPasswordException(
      final WrongPasswordException ex, final WebRequest request) {
    log.error(
        InternalErrorsEnum.INTERNAL_ERROR.getFormattedMessage(ex.getClass().getName()),
        ex.getCause());
    final var error =
  ...
  public ResponseEntity<DefaultError> handleInvalidHeaderException(
      final InvalidHeaderException ex, final WebRequest request) {
    log.error(
        InternalErrorsEnum.INTERNAL_ERROR.getFormattedMessage(ex.getClass().getName()),
        ex.getCause());
    final var error =

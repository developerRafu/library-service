...
import com.rafu.libraryservice.models.vo.requests.BookRequest;
import com.rafu.libraryservice.models.vo.responses.BookResponse;
...
public class BookController {
  ...
  public ResponseEntity<Page<BookResponse>> findAll(
    ...
    final var filter = BookFilter.builder().name(name).id(id).build();
